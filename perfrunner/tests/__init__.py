...
class PerfTest(object):
    ...
    def load(self):
        ...
        if load_settings:
            ...
            self.worker_manager.run_workload(load_settings,
    ...
    def access(self):
        ...
        if access_settings:
            ...
            access_settings.n1ql_queries = getattr(
                self, 'n1ql_queries', access_settings.n1ql_queries)
    ...
    def access_bg(self):
        ...
        if access_settings:
            ...
            access_settings.index_type = None
            if self.test_config.index_settings:
                access_settings.index_type = \
